...
<html lang="pl">
  ...
  <body>
    ...
    <div id="wycieczki" class="container mb-5">
      ...
      <div class="row">
          <?php for ($i = 0; $i <= count($trips) - 1; $i++){ ?>
            <div class="col-12 col-sm-6 col-lg-3">
              <div class="card">
                  <img src=<?php print "\"img/".$trips[$i]->getImg()."\"" ?> class="card-img-top" alt="...">
                  <div class="card-body">
                      <h5 class="card-title"><?php print $trips[$i]->getName() ?></h5>
                      <p class="card-text"><?php print $trips[$i]->getDescription() ?></p>
    ...
    <table class="table table-hover table-striped">
        ...
        <tbody>
          <?php foreach ($trips as $trip) :?>
              <tr>
                  <th scope="row"><?php print $trip->getId() ?></th>
                  <td><?php print $trip->getName() ?></td>
                  <td><?php print $trip->getContinent() ?></td>
                  <td><?php print $trip->getCountry() ?></td>
                  <td><?php print $trip->getPeriod() ?></td>
                  <td><?php print $trip->getPrice() ?></td>
              </tr>
          <?php endforeach ?>
        </tbody>
    </table>
